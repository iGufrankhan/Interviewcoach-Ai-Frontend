        ...
        <div className="w-full max-w-md">
          <div className="bg-white/[0.02] backdrop-blur-xl border border-white/[0.05] rounded-[2rem] p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative text-center mb-8">
              ...
              <h1 className="text-3xl font-bold mb-2 tracking-tight">Verify Reset Code</h1>
            ...
            <div className="relative">
              ...
              <form onSubmit={handleVerifyOTP} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium mb-2 text-zinc-300 text-center">Reset Code</label>
                  <input
                    type="text"
                    value={otp}
              ...
              <div className="mt-4 text-center">
                <Link href="/reset-password" className="text-zinc-500 hover:text-zinc-300 text-sm transition-colors">
